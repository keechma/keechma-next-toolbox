...
(def prepend-collection edb/prepend-collection)
(def append-collection edb/append-collection)
...
(def prepend-collection! (keechma-pt/make-api-proxy pt/prepend-collection!))
(def append-collection! (keechma-pt/make-api-proxy pt/append-collection!))
